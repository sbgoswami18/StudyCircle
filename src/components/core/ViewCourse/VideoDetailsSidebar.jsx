...
export default function VideoDetailsSidebar({ setReviewModal }) {
  const [activeStatus, setActiveStatus] = useState("") // activeStatus contains current section's id
  const [videoBarActive, setVideoBarActive] = useState("") // videoBarActive contains current subSection's(lecture's) id
  ...
  return (
    <>
      <div className="flex h-[calc(100vh-3.5rem)] w-[screen] lg:w-[320px] lg:max-w-[350px] flex-col lg:border-r-[1px] border-t-[4px] border-t-richblack-700 lg:border-r-richblack-700 bg-richblack-800">
